#ifndef _ALTERA_FFT_DDR_BRIDGE_H_
#define _ALTERA_FFT_DDR_BRIDGE_H_
...
/*
 * This file contains macros for module 'fft_ddr_bridge' and devices
...
#endif /* _ALTERA_FFT_DDR_BRIDGE_H_ */
