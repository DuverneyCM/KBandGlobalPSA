	FifoKBandOUT u0 (
		.data    (_connected_to_data_),    //   input,  width = 4096,  fifo_input.datain
		...
		.q       (_connected_to_q_),       //  output,   width = 128, fifo_output.dataout
		.wrusedw (_connected_to_wrusedw_), //  output,     width = 3,            .wrusedw
