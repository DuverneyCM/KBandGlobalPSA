...
# Mon Oct 22 11:36:02 COT 2018
# DO NOT MODIFY


# 
# KBand21affine "KBand 2in 1out affine" v1.0
# Duverney Corrales Mendoza 2018.10.22.11:36:02
# 
# 
...
# 
# module KBand21affine
# 
set_module_property DESCRIPTION ""
set_module_property NAME KBand21affine
set_module_property VERSION 1.0
set_module_property INTERNAL false
set_module_property OPAQUE_ADDRESS_MAP true
set_module_property GROUP ADN_Alignment
set_module_property AUTHOR "Duverney Corrales Mendoza"
set_module_property DISPLAY_NAME "KBand 2in 1out affine"
...
add_fileset_file KBandIP21affine.vhd VHDL PATH KBandIP21affine.vhd TOP_LEVEL_FILE


# 
# parameters
# 
add_parameter NoCell NATURAL 32
set_parameter_property NoCell DEFAULT_VALUE 32
...
add_parameter bitsOUT NATURAL 64
set_parameter_property bitsOUT DEFAULT_VALUE 64
...
add_parameter dimLUT NATURAL 4
set_parameter_property dimLUT DEFAULT_VALUE 4
set_parameter_property dimLUT DISPLAY_NAME dimLUT
set_parameter_property dimLUT TYPE NATURAL
set_parameter_property dimLUT UNITS None
set_parameter_property dimLUT ALLOWED_RANGES 0:2147483647
set_parameter_property dimLUT HDL_PARAMETER true
...
set_interface_property clock_external clockRate 200000000
...
add_interface_port iADN1 iADN1_data data Input 32
...
add_interface_port oArrow oArrow_data data Output 128
...
# 
add_interface Parameters conduit end
set_interface_property Parameters associatedClock ""
set_interface_property Parameters associatedReset ""
set_interface_property Parameters ENABLED true
set_interface_property Parameters EXPORT_OF ""
set_interface_property Parameters PORT_NAME_MAP ""
set_interface_property Parameters CMSIS_SVD_VARIABLES ""
set_interface_property Parameters SVD_ADDRESS_GROUP ""

add_interface_port Parameters iParameters export Input 32


# 
# connection point iADN2
# 
add_interface iADN2 avalon_streaming end
set_interface_property iADN2 associatedClock clock_external
set_interface_property iADN2 associatedReset reset
set_interface_property iADN2 dataBitsPerSymbol 8
set_interface_property iADN2 errorDescriptor ""
set_interface_property iADN2 firstSymbolInHighOrderBits true
set_interface_property iADN2 maxChannel 0
set_interface_property iADN2 readyLatency 0
set_interface_property iADN2 ENABLED true
set_interface_property iADN2 EXPORT_OF ""
set_interface_property iADN2 PORT_NAME_MAP ""
set_interface_property iADN2 CMSIS_SVD_VARIABLES ""
set_interface_property iADN2 SVD_ADDRESS_GROUP ""

add_interface_port iADN2 iADN2_data data Input 32
add_interface_port iADN2 iADN2_valid valid Input 1
add_interface_port iADN2 oADN2_ready ready Output 1
