...
module KBandIPsubPro_altera_merlin_traffic_limiter_191_kcba44q
#(
   parameter
      PKT_TRANS_POSTED           = 1,
      PKT_DEST_ID_H              = 0,
   ...
   generate
      if (REORDER) begin: fifo_dest_id_write_read_control_reorder_on
         ...
         for (j = 0;j < MAX_DEST_ID; j = j+1) begin : trans_sequence_per_fifo
            ...
            KBandIPsubPro_altera_merlin_traffic_limiter_191_tx37unq #(
                  .SYMBOLS_PER_BEAT   (1),
            ...
            //alt_hiconnect_sc_fifo # (
              KBandIPsubPro_altera_merlin_traffic_limiter_191_752txqq # (
                .IMPL                  ("reg"),
                .SYMBOLS_PER_BEAT      (1),   
