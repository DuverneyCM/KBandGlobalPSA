// KBandIPsubPro_KBandOutput_altera_msgdma_191_kl463si.v
...
`timescale 1 ps / 1 ps
module KBandIPsubPro_KBandOutput_altera_msgdma_191_kl463si (
	...
	write_master #(
		...
		.master_byteenable         (mm_write_byteenable),                            //  output,   width = 16,                  .byteenable
		.master_writedata          (mm_write_writedata),                             //  output,  width = 128,                  .writedata
		.master_waitrequest        (mm_write_waitrequest),                           //   input,    width = 1,                  .waitrequest
		.snk_data                  (st_sink_data),                                   //   input,  width = 128,         Data_Sink.data
