	KBandIPsubPro_KBandInput_1 u0 (
		...
		.mm_read_readdata             (_connected_to_mm_read_readdata_),             //   input,    width = 8,                 .readdata
		...
		.st_source_data               (_connected_to_st_source_data_),               //  output,    width = 8,        st_source.data
