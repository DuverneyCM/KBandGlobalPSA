// KBandIPsubPro_KBandInput_1_altera_msgdma_191_oqmyswq.v
...
`timescale 1 ps / 1 ps
module KBandIPsubPro_KBandInput_1_altera_msgdma_191_oqmyswq (
	...
	read_master #(
		...
		.master_readdata      (mm_read_readdata),                              //   input,    width = 8,                 .readdata
		...
		.src_data             (st_source_data),                                //  output,    width = 8,      Data_Source.data
